  ...
  return (
    ...
    className="flex bg-contain md:h-screen md:overflow-hidden">
      ...
      <p className="text-white text-sm text-center md:text-left">
        ...
        Powered by <a className="text-red-400 hover:text-red-600" href="https://www.dnd5eapi.co/" target="_blank">DND 5e API</a>
        </p>
...
setData={(val)=>setData(val)}  />
        ...
        <div
        className="w-full md:w-1/2 md:overflow-y-scroll">
          <Card
